...
keywords:
  ...
  - minecraft
  - udp
thumbnail: https://img.dragoncloud.win/blog/images/posts/photo_2023-08-15_15-28-43.jpg
thumbnailAlt: 一张展现了AI回应人类错误的信息的截图。
images:
  - https://img.dragoncloud.win/blog/images/posts/photo_2023-08-15_15-28-43.jpg
...
在评论区有网友指出作者先前所给出的IPv6 DNS服务器实为Google DNS64 服务器，经过调研，笔者发现原先所用的DNS服务器确实为Google DNS64而非Google Public DNS。本篇文章的疏忽大致是由以下几点原因造成：
  ...
  {{< figure src="https://img.dragoncloud.win/blog/images/posts/photo_2023-08-15_15-28-43.jpg" alt="一张展现了AI回应人类错误的信息的截图。" >}}
